...
CREATE TABLE IF NOT EXISTS USERS (
	...
	ACCOUNT_AMOUNT DECIMAL(13,2) DEFAULT 0.00,
...
INSERT INTO USERS(USER_ID, FIRST_NAME, LAST_NAME, ACCOUNT_AMOUNT)
VALUES
...
INSERT INTO BETS(BET_ID, USER_ID, EVENT_ID, MARKET, ODDS, AMOUNT, EST_PROFIT, ON_TEAM, TYPE, STATUS, FRIEND, WON)
VALUES
    (1, 1, 1, 'exchange', 200, 20.00, 40.00, 'Team 1', 'market', 'active', NULL, NULL),
    (2, 1, 1, 'social', 100, 10.00, 10.00, 'Team 1', NULL, 'active', 2, NULL),
    (3, 2, 1, 'social', -100, 10.00, 10.00, 'Team 2', NULL, 'active', 1, NULL),
    (4, 1, 1, 'social', -100, 40.00, 40.00, 'Team 2', NULL, 'pending friend', 3, NULL),
    (5, 3, 1, 'social', 100, 40.00, 40.00, 'Team 1', NULL, 'pending user', 1, NULL),
    (6, 1, 3, 'exchange', 100, 10.00, 10.00, 'Team 5', 'market', 'completed', NULL, 1);
